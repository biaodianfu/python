...
class QunarPcScenicInfoStart():
    ...
    def run(self):
        log_path = self.conf['spider_log_path']+'/QunarPcScenicInfoSpider/spider_log_'+str(int(time.time()))
        sys.argv = ["scrapy", "crawl", "QunarPcScenicInfoSpider", "--logfile="+log_path]
