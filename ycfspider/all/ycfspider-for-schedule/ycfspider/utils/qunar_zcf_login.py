...
class QunarZcfLogin():
    ...
    def __init__(self):
        self.redis_key =  'login:qunar_zcf_login'
    ...
    def login(self,user_name,pwd,login_url,channel_number):
        cookie = self.login_util.qunar_zcf_login(user_name,pwd,login_url)
        if cookie:
